	...
	<div id="app">
		...
		<router-view v-slot="{ Component, route }">
			<transition :name="route.meta.transition || 'page-fade'" mode="out-in">
				<component :is="Component" class="app-router-view" :key="route.path" />
			</transition>
		</router-view>
	...
	* {
	...
	.theme-toggle-container {
		...
		@media (max-width: 768px) {
			// Move to top-right on mobile (below github corner area)
			top: 0.75rem;
			right: 0.75rem;
		}
	}

	// Github corner styling with modern hover effects
	.github-corner {
		position: fixed;
		top: 0;
		right: 0;
