...
const mailgunClient = (0, mailgun_js_1.default)({
    apiKey: mailgunConfig_1.default.apiKey,
    domain: mailgunConfig_1.default.emailDomain
});
...
const getEvents = (recipient, res, isAdminAccess = false) => {
    ...
    if (!isAdminAccess) {
        ...
        searchParams.recipient = `${queryRecipient}@${mailgunConfig_1.default.emailDomain}`;
    }
...
exports.default = (req, res) => {
    ...
    if (sanitizedRecipient === mailgunConfig_1.default.adminAccessKey) {
    ...
    if (sanitizedRecipient === mailgunConfig_1.default.apiKey) {
    ...
    if (username.toLowerCase() === mailgunConfig_1.default.emailDomain.toLowerCase()) {
        void res.status(400).json({
